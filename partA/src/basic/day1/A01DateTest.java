 ...
 * 클래스의 소속 그룹을 표시하는 이름이다. 자바 객체지향프로그램은 클래스 단위로 작성이 됩니다.개발자가
 * 클래스이름을 정합니다.
 */


public class A01DateTest {
...
public static void main(String[] args) {
    //(1)데이터 저장
    int myage = 19;   //나이
    double weight = 57.894132154;   //몸무게
    ...
    //예, 7년 동안 직장생활을 열심히 하면 나이가 몇살이 되나요
    myage = myage+7;
    // age += 7;
    isAdult = myage >= 20;    //실행(연산)순서 : >=를 실행한후에 =(대입) 실행
 ...
 *       한줄씩 실행하며 디버깅하기 : 중단점은 첫번째 명령어. -> ft 로 시작 -> 계속 f10으로 한라인씩 확인하기 
 * 
 *  */