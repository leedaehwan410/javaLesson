...
// static이 많아지면 상속의 특징을 사용할 수 없다. 멀티 스레드 환경에 적합하지 않다.
//      -> 여기서는 
        ...
        while (run) {       //메뉴 선택 반복
            ...
            switch (select) {
                ...
                case "C","c":
                    ...
                    break;    
                case "P","p":
                    System.out.println("상품명 검색어 입력 __ ");
                    ...
                    break;
                case "D","d":
                    System.out.println("삭제할 상품 인덱스 입력 __ ");
                    int idx = Integer.parseInt(System.console().readLine());
                    if(buyDao.delete(idx)==1)
                        System.out.println("삭제가 완료되었습니다");
                    else    
                        System.out.println("없는 구매번호 입니다.");
                    break;
                case "B","b":
                    System.out.println("구매할 상품 코드를 입력 __ ");
                    String pcode = System.console().readLine();
                    System.out.println("구매할 상품의 갯수를 입력. __ ");
