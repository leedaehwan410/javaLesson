...
public class A27ArrayBasic {
	//괄호의 종류 : ()는 소괄호. 메소드에서 쓰임.	{}는 중괄호. 블록(영역) 지정	[]는 대괄호. 배열정의 쓰임.(초기화할때는 중괄호)
	public static void main(String[] args) {
		...
		System.out.println("70 이상 값 개수="+count);
		...
		System.out.println("arr2 배열값 출력");
		System.out.println(arr2);	//[I@5b6f7412
		printArray(arr2); 	//배열 요소의 값을 출력하는 메소드

		System.out.println("arr1 배열값 출력");
		System.out.println(arr1);	//[I@4fca772d
		printArray(arr1);	
		//메모리에 저장되는 데이터는 주소를 갖습니다.
		//arr1,arr2는 배열의 이름은 배열의 시작주소.
		//메소드가 실행될때 배열의 시작주소를 메소드의 인자로 전달합니다.
		}
