...
public class C01ListExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n addAll strlist 실행 후 :" + strlist);
        strlist.add("아이브");
        System.out.println("\n 이미 저장되어 있는 값도 추가 됩니까? :" +strlist);       //중복값 허용
        System.out.println("\n\n리스트에서 항목 찾기");
        //contains
 ...
 *                         배열에 없는 '삭제' 기능이 있습니다. 그 외에도 조회와 관련 기능 등
 *                         조작과 조회를 다양하게 할 수 있습니다.
 */