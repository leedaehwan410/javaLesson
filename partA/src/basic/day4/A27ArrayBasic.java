...
public class A27ArrayBasic {
	// 괄호의 종류 : ()는 소괄호, 메소드에서 쓰임. 		{}는 중괄호. 블록(영역 지정) 		[]는 대괄호. 배열정의에 쓰임. (초기화할 때는 중괄호)
	public static void main(String[] args) {
		...
		System.out.println("i=0, arr1[0]=" + arr1[0]);		//[] 기호안에 인덱스 정수값 작성하기.	//34
		...
		System.out.println(arr2 + "!!!!!!!!!!!!!!!!!!!!!");		// I@5b6f7412 출력.
		...
		// 메소드가 실행될 때 배열의 시작주소를 메소드의 인자로 전달합니다.
	}
			
			
			public static void printArray(int[] array){		// 전달받은 배열주소로 데이터를 가져오기 한다.
