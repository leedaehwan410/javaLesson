...
//      프로그램 실행은 서버감 먼저 실행하기.
public class Server {
    
    public static void main(String[] args) {
        ServerSocket server = null;
        Socket socket =null;
        BufferedOutputStream bos = null;    DataInputStream dis = null; 
        ...
        InputStream is = null;
            ...
            // 클라이언트가 보낸 인사말받기
               ...
               //파일명은 "d:\\다운로드.jpg"        다운로드 위치는 d드라이브
               ...
               bos = new BufferedOutputStream(new FileOutputStream("D:\\upload\\"+filename));
                ...
                //자원해제. close()
                try{server.close() ; socket.close(); bos.close(); os.close(); dos.close(); dis.close(); }catch(IOException e) {}
            }
