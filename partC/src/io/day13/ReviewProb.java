...
public class ReviewProb {
    ...
    public static void prob_10() {
        ...
        try {
            ...
            e.printStackTrace();
            /*e.printStackTrace() 메소드로 실행되는 결과 예시. trace는 추적하다. 예외 원인을 추적해서 출력 
             *  at java.base/java.lang.NumberFormatException.forInputString(NumberFormatException.java:67)
                at java.base/java.lang.Integer.parseInt(Integer.java:668)
                at java.base/java.lang.Integer.parseInt(Integer.java:786)
                at io.day13.ReviewProb.prob_10(ReviewProb.java:34)
                at io.day13.ReviewProb.main(ReviewProb.java:9)
             * 
             */
        }
