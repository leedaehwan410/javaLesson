...
public class C02MemberList {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("수정후 리스트 내용 :" + list+",크기:"+list.size());

        System.out.println("특정 멤버 조회 : " + list.lastIndexOf(new Member("dahy", 21)));
        ...
        //                   그외에는 comparator 를 구현해야합니다.

        //List 의 static 메소드
        //      ㄴ의 테스트용 리스트 만들 때 많이 사용합니다.불변객체 입니다.
