...
public class OracleConnectionTest {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            //      java 6 부터 jdbc4.0 버전이 지원되고 그 때부터 생략합니다.
            ...
            //3) Connection은 인터페이스에 대한 구현은 드라이버에 따라 정해짐.
            ...
            if (conn != null) {
                ...
                + conn.getClass().getName());   //Connection 구현 클래스 이름 확인
                                        // oracle.jdbc.driver.T4CConnection 는 Connection 구현 클래스
