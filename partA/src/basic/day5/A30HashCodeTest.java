...
public class A30HashCodeTest {
    ...
    public static void main(String[] args) {
        ...
        //hashcode 는 참조값(식별값)을 만들기 위해 '해쉬함수(수학적)'로 생성된 결과입니다.
        System.out.println(iArray); //배열의 식별값을 보여줍니다.    (16진수 8자리) [I@4517d9a3
        System.out.println("초기 해시코드  :"+iArray.hashCode());  //해쉬코드값을 가져옵니다.(10진수)  1159190947
        System.out.println(Integer.toHexString(iArray.hashCode())); // 10진수를 16진수로 변환 4517d9a3
        //결국 해쉬코드는 식별값과 똑같아짐

        iArray[3]=99;
        System.out.println("배열 요소값을 변경한후 해시코드 : "+iArray.hashCode());
