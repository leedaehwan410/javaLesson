...
public class JavaDateTypeTest {
     ...
     * 1) java.util 패키지의 Date,Calendar 클래스 : jdk1.1 버전부터.
    ...
    System.out.println("---현재시간을 ms 로 구하는 방식은 모든 프로그래밍언에어서 사용됩니다.");

    System.out.println("\n2. 약 54 년을 직접 ms 로 계산해 봅니다.");
    ...
    System.out.println("-------------------------------");
    //java.sql.Date는 기본 생성자 동작 없습니다. long 탕비 인자가 필요합니다.
