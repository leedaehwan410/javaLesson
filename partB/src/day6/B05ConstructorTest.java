...
public class B05ConstructorTest {
    ...
    public static void main(String[] args) {
        ...
        MyClass4 my4 = new  MyClass4("good", 100, new double[3]);
        ...
        //기본생성자와 setter 가 없는 MyClass5 객체생성합시다
        ...
        System.out.println("\tmy5 field3 :"+Arrays.toString(my5.getField3()));  

        MyClass3 test = new MyClass3();
        test.setField1("파이썬");
        test.setField2(999);
        test.setField3(new double[]{1.0,2,30});
